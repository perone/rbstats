...
def run_main():
        ...
        parser.add_argument('--max-results', type=int,
                ...
                default=200)
        parser.add_argument('--status', choices=['discarded', 'pending', 'submitted'],
                help='Only retrieve Review Requests with this status (default: %(default)s)',
                default='submitted')
        parser.add_argument('--colormap',
                help='The colormap that should be used for the plotting (default: %(default)s)',
                default='jet')
        parser.add_argument('--interpolation', help='Interpolation method to use (default: %(default)s',
                default='gaussian', choices=['none', 'nearest', 'bilinear', 'bicubic',
        ...
        im = ax.imshow(arr, cmap=plt.get_cmap(args.colormap), interpolation=args.interpolation)
